(function () {
    ...
    MaterialDateTextfield.prototype.zeroFill_ = function (x) {
        var s = x.toString();
        var patterns = (s.length === 1 ? [s, '0' + x] : [s]).map(MaterialDateTextfield.prototype.pattern_.literal);
    ...
    MaterialDateTextfield.prototype.AdditionalDays = MaterialDateTextfield.prototype.pattern_.choice(
        MaterialDateTextfield.prototype.flatMap(MaterialDateTextfield.prototype.DaysInAMonth, function (pair) {
            return MaterialDateTextfield.prototype.range(29, pair.days + 1)
              .map(function (x) {
                  return [MaterialDateTextfield.prototype.pattern_.literal(x.toString()), MaterialDateTextfield.prototype.Delimiters, pair.month]
    ...
    MaterialDateTextfield.prototype.DatePattern = MaterialDateTextfield.prototype.pattern_.choice([
         [MaterialDateTextfield.prototype.pattern_.choice(MaterialDateTextfield.prototype.Days), MaterialDateTextfield.prototype.Delimiters, MaterialDateTextfield.prototype.pattern_.choice(MaterialDateTextfield.prototype.Months), MaterialDateTextfield.prototype.Delimiters, MaterialDateTextfield.prototype.Years].reduce(MaterialDateTextfield.prototype.pattern_.sequence),
